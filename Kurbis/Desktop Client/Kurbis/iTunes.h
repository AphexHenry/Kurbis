...
enum iTunesEExF {
	iTunesEExFPlainText = 'kTXT',
	iTunesEExFUnicodeText = 'kUCT',
	iTunesEExFXML = 'kXML',
	iTunesEExFM3U = 'kM3U',
	iTunesEExFM3U8 = 'kM38'
};
typedef enum iTunesEExF iTunesEExF;
...
- (NSString *) exportAs:(iTunesEExF)as to:(NSURL *)to;  // export a source or playlist
